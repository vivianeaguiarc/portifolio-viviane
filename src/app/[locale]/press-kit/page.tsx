...
export async function generateMetadata({
  ...
  return createPageMetadata({
    ...
    locale: typedLocale,
    canonicalPath: getPathname({ locale: typedLocale, href: "/press-kit" }),
    alternatePaths: getStaticPageAlternatePaths("/press-kit"),
  });
}
...
export default async function PressKitPage({ params }: PageProps) {
  ...
  return <PressKitContent locale={locale as Locale} />;
}
