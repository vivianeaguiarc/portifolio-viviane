...
import { NowContent } from "@/components/sections/now-content";
...
export async function generateMetadata({
  ...
  return createPageMetadata({
    ...
    locale: typedLocale,
    canonicalPath: getPathname({ locale: typedLocale, href: "/now" }),
    alternatePaths: getStaticPageAlternatePaths("/now"),
  });
}
...
export default async function NowPage({ params }: PageProps) {
  ...
  return <NowContent locale={locale as Locale} />;
}
